...
def run_test_practice_problem2a():
    ...
    actual = practice_problem2a([1, 2, 3, 4, 5, 6], 10)
    print('Expected: ', expected)
    print('Actual: ', actual)
    #Test 2
    expected = [5, 4, 2, 90]
    actual = practice_problem2a([5, 4, 2, 90], 0)
    print('Expected: ', expected)
    print('Actual: ', actual)
    # Test 3
    expected = [132]
    actual = practice_problem2a([10], 122)
    print('Expected: ', expected)
    print('Actual: ', actual)
    #Test 4
    expected = [4, 4, 4, 9, 11, 21, 34]
    actual = practice_problem2a([3, 3, 3, 8, 10, 20, 33], 1)
    print('Expected: ', expected)
    print('Actual: ', actual)
